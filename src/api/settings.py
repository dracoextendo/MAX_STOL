...
router = APIRouter(prefix="/settings", dependencies=[Depends(access_token_validation)])

@router.get('/desk-colors', summary="Получить все цвета столешниц", tags=['Цвет столешницы'])
async def get_all_desk_colors():
    return await DeskColorDAO.find_all()

@router.get('/desk-colors/{id}', summary="Получить цвет столешницы по id", tags=['Цвет столешницы'])
...
@router.post('/desk-colors/add', summary="Добавить цвет столешницы", tags=['Цвет столешницы'])
...
@router.put('/desk-colors/{id}', summary="Изменить цвет столешницы", tags=['Цвет столешницы'])
...
@router.delete('/desk-colors/{id}', summary="Удалить цвет столешницы", tags=['Цвет столешницы'])
async def delete_desk_color_by_id(id: int):
    return await DeskColorDAO.delete_desk_color(id)

@router.get('/frame-colors', summary="Получить все цвета металлокаркаса", tags=['Цвет металлокаркаса'])
async def get_all_frame_colors():
    return await FrameColorDAO.find_all()

@router.get('/frame-colors/{id}', summary="Получить цвет металлокаркаса по id", tags=['Цвет металлокаркаса'])
...
@router.post('/frame-colors/add', summary="Добавить цвет металлокаркаса", tags=['Цвет металлокаркаса'])
...
@router.put('/frame-colors/{id}', summary="Изменить цвет металлокаркаса", tags=['Цвет металлокаркаса'])
...
@router.delete('/frame-colors/{id}', summary="Удалить цвет металлокаркаса", tags=['Цвет металлокаркаса'])
async def delete_frame_color_by_id(id: int):
    return await FrameColorDAO.delete_frame_color(id)

@router.get('/lengths', summary="Получить все длины столов", tags=['Длина стола'])
async def get_all_lengths():
    return await LengthDAO.find_all()

@router.get('/lengths/{id}', summary="Получить длину стола по id", tags=['Длина стола'])
...
@router.post('/lengths/add', summary="Добавить длину стола", tags=['Длина стола'])
...
@router.put('/lengths/{id}', summary="Изменить длину стола", tags=['Длина стола'])
...
@router.delete('/lengths/{id}', summary="Удалить длину стола", tags=['Длина стола'])
async def delete_length_by_id(id: int):
    return await LengthDAO.delete_length(id)

@router.get('/depths', summary="Получить все глубины столов", tags=['Глубина стола'])
async def get_all_depths():
    return await DepthDAO.find_all()

@router.get('/depths/{id}', summary="Получить глубину стола по id", tags=['Глубина стола'])
...
@router.post('/depths/add', summary="Добавить глубину стола", tags=['Глубина стола'])
...
@router.put('/depths/{id}', summary="Изменить глубину стола", tags=['Глубина стола'])
...
@router.delete('/depths/{id}', summary="Удалить глубину стола", tags=['Глубина стола'])
